                        ...
                        <div className='border-b border-gray-900/10 pb-12 mt-4'>
                            ...
                            <div className='mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6'>
                                <div className='sm:col-span-2'>
                                    ...
                                    <div className='mt-2'>
                                        <input placeholder='' type='text' name='first-name' value={formData.firstName} id='first-name' onChange={e => handleInputChange('firstName', e)} className='w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6 pl-2' />
                                    </div>
                                </div>
                                <div className='sm:col-span-2'>
                                    ...
                                    <div className='mt-2'>
                                        <input placeholder='' type='text' name='middle-name' value={formData.middleName} id='middle-name' onChange={e => handleInputChange('middleName', e)} className='w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6 pl-2' />
                                    </div>
                                </div>
                                <div className='sm:col-span-2'>
                                    ...
                                    <div className='mt-2'>
                                        <input placeholder='' type='text' name='last-name' value={formData.lastName} id='last-name' onChange={e => handleInputChange('lastName', e)} className='w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6 pl-2' />
                                    </div>
                                </div>
                                ...
                                <div className='sm:col-span-2'>
                                    ...
                                    <div className='mt-2'>
                                        <input type='text' value={formData.phoneNumber} onChange={e => handleInputChange('phoneNumber', e)} name='phone-number' id='phone-number' autoComplete='family-name' className='block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6 pl-2' />
                                    </div>
                                </div>
                                ...
                                <div className='sm:col-span-2'>
                                    ...
                                    <div className='mt-2'>
                                        <input type='email' value={formData.email} onChange={e => handleInputChange('email', e)} name='last-name' id='last-name' autoComplete='family-name' className='block w-full focus:outline-none bg-blue-100 rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400  sm:text-sm sm:leading-6 pl-2 ' readOnly />
                                    </div>
                                </div>
                                <div className='sm:col-span-2'>
                                    ...
                                    <div className='mt-2'>
                                        <input type='text' value={formData.zipCode} onChange={e => handleInputChange('zipCode', e)} name='zip-code' id='zip-code' autoComplete='given-name' className='block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6 pl-2' />
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className='mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6'>
                                <div className='sm:col-span-2'>
                                    ...
                                    <div className='mt-2'>
                                        <input type='text' value={formData.city} onChange={e => handleInputChange('city', e)} name='city' id='city' autoComplete='given-name' className='block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6 pl-2' />
                                    </div>
                                </div>
                                ...
                                <div className='sm:col-span-2'>
                                    ...
                                    <div className='mt-2'>
                                        <input type='text' value={formData.state} onChange={e => handleInputChange('state', e)} name='state' id='state' autoComplete='family-name' className='block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6 pl-2' />
                                    </div>
                                </div>
                                ...
                                <div className='sm:col-span-2'>
                                    ...
                                    <div className='mt-2'>
                                        <input type='text' value={formData.address1} onChange={e => handleInputChange('address1', e)} name='address1' id='address1' autoComplete='family-name' className='block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6 pl-2' />
                                    </div>
                                </div>
                                <div className='sm:col-span-2'>
                                    ...
                                    <div className='mt-2'>
                                        <input type='text' value={formData.address2} onChange={e => handleInputChange('address2', e)} name='address2' id='address2' autoComplete='family-name' className='block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6 pl-2' />
                                    </div>
                                </div>
                                <div className='sm:col-span-2'>
                                    ...
                                    <div className='mt-2'>
                                        <input type='text' value={formData.address3} onChange={e => handleInputChange('address3', e)} name='address3' id='address3' autoComplete='family-name' className='block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6 pl-2' />
                                    </div>
                                </div>
